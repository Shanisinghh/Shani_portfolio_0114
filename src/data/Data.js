...
export const projects = [
  ...
  },
  {
    ...
    description: "A simple form-based system for student data registration and submission.",
  ...
  },
  {
    ...
    description: "A weather forecast app that shows current weather by city using API.",
  ...
  },
  {
    ...
    description: "A tool to convert currencies using real-time exchange rates from API.",
    techStack: ["HTML", "Rapid API", "Tailwind CSS","JavaScript"]
  }
];
