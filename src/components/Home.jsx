...
function Home() {
  ...
  return (
    <>
      <div className='md:mt-16 md:h-[65vh] h-[100vh] flex flex-col-reverse md:flex md:flex-row'>
        <div  className='flex flex-col  md:w-[50%] w-[100%] h-[50%] md:pl-25 pl-2 md:pt-14 md:gap-7 gap-4'>
          <h2 data-aos='fade-right' className='md:text-7xl text-5xl font-bold text-[var(--textcolor)]'>Hi There,</h2>
          <h2 data-aos='fade-right' className='md:text-7xl text-5xl font-bold text-[var(--textcolor)]'>I'm <span className='logo-text'>Shani Babu</span></h2>
          <h4 data-aos='fade-up' className='md:text-3xl text-2xl font-semibold  text-[var(--textcolor)]'>I'm a <span className='logo-text'>{text}</span> <span className=' text-red-600'><Cursor /></span></h4>
          {/* <Link to={resume} download='resume'><button className='button'>Download CV</button></Link> */}
          <a data-aos='fade-up' href={resume} download='shani-resume'><button className='flex items-center justify-center gap-2 button w-43'><MdOutlineFileDownload className='text-2xl'/><span>Download</span></button></a>
          <div data-aos='fade-up' className='flex gap-2.5'>
